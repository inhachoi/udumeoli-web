import{j as e}from"./jsx-runtime-u17CrQMm.js";import{H as d}from"./header-B5_TIoIU.js";import{a as p}from"./utils-WKja2AN6.js";import"./x-CPFu4qxL.js";import"./createLucideIcon-CCGLdiIf.js";import"./iframe-DgxGP9F_.js";import"./preload-helper-PPVm8Dsz.js";import"./arrow-left-C5igRMyB.js";function r({children:s,className:n,...i}){return e.jsx("div",{className:p("mx-auto min-h-dvh w-full max-w-md bg-background shadow-[0px_0px_80px_0px_rgba(142,150,169,0.35)] ring-1 ring-neutral-900/5",n),...i,children:s})}r.__docgenInfo={description:"",methods:[],displayName:"MobileLayout"};const f={component:r,tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:["모든 페이지를 감싸는 모바일 영역 컨테이너.","","- **기준 크기 375×812** (iPhone X). 이 크기에서 시안과 1:1로 보입니다.","- 더 작은 폰(360 등)은 자동으로 줄어듭니다. (min 없음)","- 더 큰 화면은 **최대 448px**(`max-w-md`)에서 멈추고 가운데 정렬됩니다.","- 좌우 여백(거터)은 브랜드 틴트 aurora 그라디언트 배경이 균등하게 남고, 프레임은 앰비언트 섀도로 떠 보입니다.","","👉 상단 툴바의 **Viewport**를 바꿔가며 기기별로 확인하세요."].join(`
