import{j as e}from"./jsx-runtime-u17CrQMm.js";import{B as s}from"./button-B7rqy_ha.js";import{P as p}from"./plus-K5UPF13W.js";import{A as c}from"./arrow-left-B73_GR2A.js";import"./index-CqkPUm8v.js";import"./utils-WKja2AN6.js";import"./index-Lzkkukni.js";import"./iframe-DrjnhXPf.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-BqMPIB5B.js";const z={component:s,tags:["autodocs"],args:{children:"버튼"},parameters:{docs:{description:{component:["재사용 버튼. 배경(variant) · 테두리 굴곡(radius) · 그림자(shadow) · 크기(size)를 조합해 시안의 모든 버튼을 표현합니다.","","- `variant`: `solid`(배경O·다크) · `surface`(흰 배경) · `text`(배경X·글자/아이콘만) + 보조(outline/secondary/destructive/link/kakao)","- `radius`: `md`(12) · `lg`(24) · `full`(완전 둥금)","- `shadow`: `none` · `sm` · `lg`","- 풀폭 CTA는 `w-full` + 부모 좌우 패딩으로 반응형 처리."].join(`
