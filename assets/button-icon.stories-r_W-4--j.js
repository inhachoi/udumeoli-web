import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as d}from"./index-CqkPUm8v.js";import{a as p}from"./utils-WKja2AN6.js";import{U as r}from"./upload-C0MQ-oPw.js";import"./createLucideIcon-obdCP21a.js";import"./iframe-o485-tk_.js";import"./preload-helper-PPVm8Dsz.js";const u=d("inline-flex items-center justify-center rounded-full bg-bg-neutral-weak text-fg-neutral-bold shadow-[0px_0px_20px_0px_rgba(142,150,169,0.12)] transition-colors disabled:pointer-events-none disabled:bg-bg-neutral-weak-disabled disabled:text-fg-neutral-bold-disabled",{variants:{variant:{icon:"size-[42px] [&_svg]:size-6",label:"h-[42px] gap-1 px-3 text-h8 [&_svg]:size-5"}},defaultVariants:{variant:"icon"}});function a({variant:s,className:i,type:l="button",...c}){return e.jsx("button",{type:l,className:p(u({variant:s}),i),...c})}a.__docgenInfo={description:`ButtonIcon (Figma Button - Icon v1.0.0).
